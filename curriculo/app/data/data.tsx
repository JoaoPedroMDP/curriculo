...
const experiences: any = [
    ...
    },
    {
        ...
        "skills": ["Coleta de Requisitos", "Planejamento de sistemas", "Gestão de projetos"],
    ...
    },
    {
        ...
        "skills": ["Coleta de Requisitos", "Planejamento de sistemas", "Trabalhar sob pressão"],
    ...
    },
    {
        ...
        "skills": ["Product Owner", "Planejamento de sistemas", "Comunicação com cliente", "Condução de reuniões", "Planning Poker", "Briefing", "Coleta de Requisitos"],
    ...
    },
    {
        ...
        "skills": ["Resolução de problemas", "Falar em público", "Capacitação de novos membros", "Inovação", "Gestão de projetos"],
