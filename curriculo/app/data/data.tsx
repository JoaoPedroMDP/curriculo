const curriculumData: any = {
    ...
    "professional_experiences": [
        {
            ...
            "skills": ["Redes de computadores", "Bots", "APIs do Telegram/Whatsapp"],
        ...
        },
        {
            ...
            "skills": ["Redes de computadores", "APIs do Telegram/Whatsapp"],
        ...
        },
        {
            ...
            "tools": ["Laravel", "Mysql", "Dbeaver", "Postman", "API REST"],
            "skills": ["Desenvolvimento de Back-end", "Planejamento"],
        ...
        },
        {
            ...
            "skills": ["Gestão de pessoas",  "Administração de sistemas", "Capacitação de novos membros"],
        ...
        },
        {
            ...
            "tools": ["Scrum", "Backlog", "Funil de vendas", "Persona", "Planning Poker", "Briefing"],
            "skills": ["Planejamento de sistemas", "Comunicação com cliente", "Condução de reuniões"],
        ...
        },
        {
            ...
            "skills": ["Resolução de problemas", "Falar em público", "Capacitação de novos membros"],
        ...
        },
        {
            ...
            "tools": ["Laravel", "PHP", "MariaDB", "Git", "Scrum", "Postman", "PagSeguro", "Linux", "API REST"],
            "skills": ["Trabalhar sob pressão", "Trabalho em equipe", "Resolução de problemas"],
    ...
    "achievements": [
        ...
        },
        {
            ...
            "institution": "Ecomp",
            "description": "Prêmio dado ao membro mais engraçado (espero) de 2020",
            "date": "01/12/2020"
        },
        {
            "id": "4",
        ...
        },
        {
            ...
            "title": "Membro Jim Carrey",
            "institution": "Ecomp",
            "description": "Prêmio dado ao membro mais engraçado (se não for isso, me chamaram de palhaço por 2 anos seguidos) de 2021",
            "date": "01/12/2021"
        },
        {
            "id": "6",
