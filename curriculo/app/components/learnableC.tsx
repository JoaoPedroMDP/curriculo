...
export default function LearnableC({learnable, onClickHandler}: {learnable: Learnable, onClickHandler?: any}){
    ...
    let textConfig = "text-nowrap text-center group-hover:text-darkBlue text-[18px]"
    ...
    return (
    <div onClick={handleClick} className={`group flex flex-grow justify-center transition-color duration-200 ${toggled ? 'bg-darkBlue': ''} hover:bg-yellow p-5`}>
