...
export default function AchievementsSection(){
    ...
    return(
        <section id="achievements" className="bg-yellow">
            <h2 className="text-darkBlue text-center font-raleway pt-10 text-[50px] lg:text-[64px]">Conquistas</h2>
            <h3 className="text-darkBlue text-center font-medium font-raleway text-[20px] lg:text-[24px]">Consequências da paixão pelo que fazemos</h3> 
                <div className="mt-5">
                    {Object.keys(achievements).reverse().map((year) => {
                        return(
                            <div key={year} className="font-raleway flex flex-col">
                                <h4 className="text-lightBlue bg-darkBlue text-center font-raleway text-[40px] lg:text-[50px] font-bold ">{year}</h4>
